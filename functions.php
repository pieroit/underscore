...
function underscore_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'underscore' ),
	) );
...
function underscore_scripts() {
	...
	wp_enqueue_script( 'underscore-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'underscore-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
	...
	if( ! wp_is_mobile() ) {
		...
		// Animations and css dynamic css fixes
